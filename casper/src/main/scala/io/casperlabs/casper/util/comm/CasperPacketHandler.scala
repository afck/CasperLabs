...
object CasperPacketHandler extends CasperPacketHandlerInstances {
  ...
  /** Node in this state has already received at least one [[ApprovedBlock]] and it has created an instance
    ...
    **/
  class ApprovedBlockReceivedHandler[F[_]: RPConfAsk: BlockStore: Monad: ConnectionsCell: TransportLayer: Log: Metrics: Time: ErrorHandler: ExecutionEngineService](
  ...
  class CasperPacketHandlerImpl[F[_]: Monad: RPConfAsk: BlockStore: ConnectionsCell: TransportLayer: Log: Metrics: Time: ErrorHandler: LastApprovedBlock: MultiParentCasperRef: ExecutionEngineService](
